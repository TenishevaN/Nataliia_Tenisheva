...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/java_script_dynamic.js"></script>
</head>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 mx-auto">
            <form name="userForm" id="userForm" action="/user/update" method="POST" modelAttribute="user">
                <div>
