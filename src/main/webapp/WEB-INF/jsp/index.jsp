            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href=#insertModalLoginPage" data-toggle="modal"
                       data-target="#insertModalRegistrationPage"><span
                        ...
                        key="registration"></fmt:message></a>
                </li>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form style="width:300px" action="/login" method="GET" modelAttribute="user">
...
<div class="modal fade" id="insertModalRegistrationPage" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form style="width:300px" action="/user" method="POST" modelAttribute="user">
                        <div class="form-group">
                            <label for="login"><fmt:message key="login"></fmt:message></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                   value="servicemailtest2021@gmail.com"><br>
